...
public class GUIMainPageLogat extends JFrame{
    private JLabel iconita;
    private JButton toate, cabrio, combi, compacta, coupe, suv;
    private JButton admin, about, raport, programari, signout, searchBtn;
    ...
    public GUIMainPageLogat(Connection connection, User u){
        ...
        programari = new JButton("PROGRAMARI");
        programari.setSize(new Dimension(147, 41));
        programari.setBounds(959, 14, 147, 41);
        programari.setFont(new Font("Calibri", Font.BOLD, 17));
        programari.setBackground(Color.WHITE);
        programari.setForeground(Color.BLACK);
        add(programari);

        signout = new JButton("SIGNOUT");
        signout.setSize(new Dimension(147, 41));
        signout.setBounds(1125, 14, 147, 41);
        signout.setFont(new Font("Calibri", Font.BOLD, 17));
        ...
        addToPanelPrincipal(connection, "toate", u);
        ...
        coupe.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                deletePanel();
                addToPanelPrincipal(connection, "coupe", u);
            }
        });
        ...
        suv.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                deletePanel();
                addToPanelPrincipal(connection, "suv", u);
            }
        });
        ...
        compacta.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                deletePanel();
                addToPanelPrincipal(connection, "compacta", u);
            }
        });
        ...
        cabrio.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                deletePanel();
                addToPanelPrincipal(connection, "cabrio", u);
            }
        });
        ...
        combi.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                deletePanel();
                addToPanelPrincipal(connection, "combi", u);
            }
        });
        ...
        searchBtn.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (existaInDbMasina(str) == false){
                    ...
                    deletePanel();
                    addToPanelPrincipal(connection, str, u);
                }
            }
        });
        ...
        programari.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                getValori(connection, u);
                if (u.getExistaProgramare() == 1) {
                    GUIViewProgramari guiViewProgramari = new GUIViewProgramari(connection, u);
                }else{
                    JOptionPane.showMessageDialog(null, "Nu exista o programare.");
                }
            }
        });
    ...
    public void addToPanelPrincipal(Connection connection, String categorie, User u){
        panelMasina = new ArrayList<>();
        addToListPanel(connection, categorie, u);
    ...
    public void addToListPanel(Connection connection, String categorie, User u) {
        for (Produs m : masiniDinDB) {
            if (categorie.equals(m.getCategorie())) {
                ...
                btn.addActionListener(new ActionListener() {
                    @Override
                    public void actionPerformed(ActionEvent e) {
                        GUIConf guiConf = new GUIConf(connection, m, u);
                    }
                });
                masina.add(btn);
